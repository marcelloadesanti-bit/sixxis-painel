    ...
    <main className="mx-auto min-h-screen max-w-4xl p-6">
      ...
      {contas && contas.length > 0 && (
        <div className="mb-8 grid grid-cols-2 gap-4">
          ...
          >
            <p className="text-sm font-semibold text-[var(--color-sixxis-navy)]">
              Métricas →
            </p>
            <p className="text-xs text-gray-500">
              Faturamento bruto, pedidos, cancelados e devolvidos, com filtro de período
            </p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-xs text-gray-500">
              Lista detalhada de pedidos por conta, com filtro de datas
            </p>
          </Link>
        </div>
      )}
      ...
      <div className="mt-10 grid grid-cols-2 gap-4 text-sm text-gray-400 sm:grid-cols-4">
        ...
        <div className="rounded border border-gray-100 p-4">Faturamento (por último)</div>
      </div>
    </main>
  );
}
